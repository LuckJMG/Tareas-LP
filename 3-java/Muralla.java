public class Muralla extends Zona {
    ...
    public void interactuar(Cyan pikinimCyan, Magenta pikinimMagenta, Amarillo pikinimAmarillo) {
        ...
        if (tryRomper(pikinimCyan, pikinimMagenta, pikinimAmarillo)) {
            ...
            System.out.println(": A pesar del futil esfuerzo que haces para recuperar las piezas, has DESTRUIDO la muralla!!!");
    ...
    private boolean tryRomper(Cyan pikinimCyan, Magenta pikinimMagenta, Amarillo pikinimAmarillo) {
        this.vida -= pikinimCyan.cantidad * pikinimCyan.ataque;
        this.vida -= pikinimMagenta.cantidad * pikinimMagenta.ataque;
        this.vida -= pikinimAmarillo.cantidad * pikinimAmarillo.ataque;
